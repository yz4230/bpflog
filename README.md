...
1. Install Go (1.25+), clang/llvm, [bpftool](https://github.com/libbpf/bpftool), and [mise](https://mise.jdx.dev).
...
- `bpf.c`, `logf.h` - the BPF program and helpers used by the example.
